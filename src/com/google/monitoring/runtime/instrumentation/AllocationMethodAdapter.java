...
class AllocationMethodAdapter extends MethodAdapter {
   ...
   * TODO Add support for Constructor.newInstance and Class.newInstance.
   */
  @Override
    ...
    if (opcode == Opcodes.INVOKESTATIC &&
      ...
      if (signature.equals("(Ljava/lang/Class;I)Ljava/lang/Object;")) {
        ...
        super.visitMethodInsn(Opcodes.INVOKESTATIC, recorderClass,
                              recorderMethod, AllocationInstrumenter.RECORDER_SIGNATURE);
        // -> stack: ... newobj
        return;
  ...
  private void invokeRecordAllocation(String typeName) {
    ...
    super.visitMethodInsn(Opcodes.INVOKESTATIC,
                          recorderClass, recorderMethod, AllocationInstrumenter.RECORDER_SIGNATURE);
    // -> stack: ... newobj
  }
